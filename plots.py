...
def write_html_to_file(filename, dataframe):
    ...
    text_file = open(f'{PATH}/{filename}.html', "w")
    text_file.write(html)
    text_file.close()


def most_voted_suggestions_table():
...
def most_watched_suggestions_table():
...
def completed_issue_destribution_bar():
...
if __name__ == "__main__":
    ...
    most_voted_suggestions_table()
    most_voted_bugs_table()
    most_watched_suggestions_table()
    most_watched_bugs_table()
    suggestion_in_status_pie()
    bug_in_status_pie()
    completed_issue_destribution_bar()
